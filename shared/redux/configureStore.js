...
const client = axios.create({
  // baseURL: 'http://apihost/api', set your base API URL here if needed. Should be configurable.
  responseType: 'json',
});

client.interceptors.request.use(authInterceptor.success, authInterceptor.error);

function configureStore(initialState, history) {
  const enhancers = compose(
    // Middleware store enhancer.
    applyMiddleware(
      // axios middleware magic
