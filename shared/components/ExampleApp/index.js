...
class ExampleApp extends React.Component {
  render() {
    return (
      <div>
        <Helmet titleTemplate="%s | DemoApp">
          <html lang="en" />
        ...
        */}
          ...
          {/* exclude manifest for local dev for now.
        ...
        */}
        ...
        <div className="container">
          <Switch>
            {/* example private route for auth
               <PrivateRoute exact path="/" component={HomeRoute} store={this.props.store} />*/}
...
export default withRouter(connect(() => ({}))(ExampleApp));
